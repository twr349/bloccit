...
RSpec.describe SponsoredPostsController, type: :controller do
 ...
 let(:my_sponsored_post) { my_topic.sponsored_posts.create!(title: RandomData.random_sentence, body: RandomData.random_paragraph, price: RandomData.random_interger) }
  ...
  describe "POST create" do
    it "increases the number of SponsoredPost by 1" do
     expect{ post :create, params: { topic_id: my_topic.id, sponsored_post: { title: RandomData.random_sentence, body: RandomData.random_paragraph, price: RandomData.random_interger } } }.to change(SponsoredPost,:count).by(1)
    end
    
    it "assigns the new post to @sponsored_post" do
     post :create, params: { topic_id: my_topic.id, sponsored_post: { title: RandomData.random_sentence, body: RandomData.random_paragraph, price: RandomData.random_interger } }
  ...
  describe "GET edit" do
   ...
   it "assigns post to be update to @sponsored_post" do
    get :edit, params: { topic_id: my_topic.id, id: my_sponsored_post.id }
  ...
  describe "PUT update" do
   it "updates post with expected attributes" do
    ...
    new_price = RandomData.random_interger
   ...
   it "redirects to updated sponsored_post" do
    new_title = RandomData.random_sentence
    new_body = RandomData.random_paragraph
    new_price = RandomData.random_interger
